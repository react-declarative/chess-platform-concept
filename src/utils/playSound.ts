...
const soundMap = new Map<string, sound[]>(Object.entries({
    ...
    [Sound.Caller]: [
        [[6, 2], 100, { type: 'square', delay: 0 }],
        [[6, 4], 150, { type: 'square', delay: 100 }],
        [[6, 2], 100, { type: 'square', delay: 250 }],
        [[6, 4], 150, { type: 'square', delay: 350 }],
        [[6, 5], 10, { type: 'square', volume: 50, delay: 390 }],
    ],
}));
